...
-- Provinces table (normalized: integer surrogate key for consistency with existing TS models)
...
-- Categories table (integer key to match product FK references in code)
...
-- Users table (auth integrated; UUID PK + profile fields)
...
CREATE TABLE IF NOT EXISTS feedback (
    ...
    feedback_type VARCHAR(50) NOT NULL DEFAULT 'transactional',
